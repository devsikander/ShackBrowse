...
public class ComposePostView extends AppCompatActivity {
                ...
                switch (which) {
                    case 0:
                        ...
                        for (int i = 0; i < str.length(); ) {
                            String curTag = "";
                            String curOpenBracket = "{";
                            String curCloseBracket = "}";
                            if ((i % 3) == 0) {
                                curTag = "r";
                                curOpenBracket = "{";
                                curCloseBracket = "}";
                    ...
                    case 7:
                        ...
                        for (int i = 0; i < str.length(); ) {
                            ...
                            Random r = new Random();
                            int k = r.nextInt(2);
                            String chr = new StringBuilder().appendCodePoint(str.codePointAt(i)).toString();
    ...
    void uploadImage(Uri imageUri) {
        ...
        if (imageUri != null) {
            ...
            System.out.println("UPLOADIMAGEuri: " + imageUri.toString());
        }
    ...
    public void actionTemplate(final String keyword) {
        ...
        builder.setPositiveButton("Load", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ComposePostView.this);
                builder.setTitle("Really Load?");
                builder.setMessage("Loading `" + keyword + "` will replace your current post text.");
                builder.setPositiveButton("Load", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        EditText edit = (EditText) findViewById(R.id.textContent);
        ...
        builder.setNeutralButton("Delete", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                builder.setMessage("Deleting `" + keyword + "` will make you sad, possibly.");
