...
public class User {
    ...
    private final static HashSet<String> MODS = new HashSet<String>(Arrays.asList(new String[]{"axeman808", "daeadin", "evildolemite", "hirez", "quix", "serpico74", "vincent grayson"}));
