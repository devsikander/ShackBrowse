...
public class PostQueueObj {
    ...
    public long getPostQueueId() {
        return _postid;
    }

    boolean isMessage() {
        return _ismessage == 1 ? true : false;
    }

    String getContentTypeId() {
        return Integer.toString(_contenttypeid);
    }
    ...
    public int getIntContentTypeId() {
        return _contenttypeid;
    }

    public void setFinalId(int fid) {
        _finalid = fid;
    }
