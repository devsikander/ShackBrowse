...
public class PushNotificationSetup {
    public static void SetupNotificationChannels(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.setDescription("Notifications when new posts come in that are replies, mentions or keyword matches");
            ...
            channel.setDescription("Notifications when someone sends you a private message");
            channel.enableLights(true);
            channel.setLightColor(Color.GREEN);
            channel.enableVibration(true);
            notificationManager.createNotificationChannel(channel);
            channel = new NotificationChannel(NotifierReceiver.CHANNEL_SYSTEM, "System Notifications", NotificationManager.IMPORTANCE_LOW);
            channel.setDescription("Notifications from the app, such as post queue notifications");
            channel.enableLights(true);
            channel.setLightColor(Color.GREEN);
